Usefully for encoding videos that you want to be embeddable on the web, like in Discord.

Modify the the "crf" flag between 0–63 to change the constrained quality.
Modify the "deadline" flag between realtime, good, and best to change speed of encode.
