...
:: Set paths
set path=%AV1%\dependencies\vapoursynth64;%AV1%\dependencies\ffmpeg-5.1.2;%AV1%\dependencies\ffmpeg-latest;%AV1%\dependencies\mkvtoolnix;%AV1%\dependencies\svt-av1;%AV1%\dependencies\x264;%AV1%\dependencies\x265;%AV1%\dependencies\rav1e;%AV1%\dependencies\aom
